...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    ...
    >
      <Card className="flex flex-col h-full overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] bg-white border border-vectoria-blue-pastel hover:border-vectoria-cta-orange">
        <CardHeader>
          {service.image && (
            <div className="mb-4">
